...
- Name: نام قالب رو نشون میده
- Description: توضیحاتی برای نمایش
- ProjectType: نوع پروژه که در اینجا سی شارپ هست
...
- ProjectCollection: برای اینکه لیستی از پروژه ها بتونیم اضافه کنیم باید از این تگ استفاده کنیم
    - SolutionFolder: برای اینکه در solution بتوانیم پروژه ها را در یک فولدر قرار دهیم استفاده میکنیم. در اینجا تمام پروژه ها در فولدر src قرار میگیره
        - ProjectTemplateLink: این تگ برای لینک کردن به پروژه مورد نظر هست. `ProjectName` نام پروژه ای که در solution قرار میگیره هست و داخل تگ آدرس اون پروژه مسیر دهی میشه
...
- فایل zip خروجی رو به راحتی میتونید روی فایل قبلی که ایجاد کرده بودید replace کنید. 
- نسخه ویژوال استودیو من 17 یا 2019 هست
